    ...
    <div className="relative z-10 flex flex-col justify-between border border-sky-border bg-sky-card-bg shadow-lg shadow-black/20 rounded-2xl hover:-translate-y-0.5 transition-all duration-200">
      <div className="p-1 md:p-2 flex flex-col gap-1">
        <textarea
          ...
          className="shrink-0 w-full resize-none overflow-hidden bg-transparent outline-none font-black text-base sm:text-lg text-sky-text placeholder:text-sky-placeholder"
        />
        ...
        <textarea
          ...
          onBlur={save}
          onInput={(e) => autosize(e.currentTarget)}
          className="shrink-0 w-full resize-none overflow-hidden bg-transparent outline-none text-xs md:text-sm text-sky-text-muted placeholder:text-sky-placeholder"
        />
      </div>
      ...
      <div className="shrink-0 w-full px-2 py-1 flex items-center justify-between gap-2 bg-sky-card-footer rounded-b-2xl">
        ...
        <div className="relative">
          <button
            ...
            className="text-sky-text-muted hover:text-sky-text transition-colors cursor-pointer p-1"
          >
            ...
            createPortal(
              ...
              >
                <button
                  ...
                  className="px-3 py-2 font-bold text-xs text-left text-sky-text hover:bg-sky-dropdown-hover transition-colors cursor-pointer"
                >
                  Copy
                </button>
                <button
                ...
                <button
                  ...
                  className="px-3 py-2 font-bold text-xs text-left text-sky-danger hover:bg-sky-danger-hover transition-colors cursor-pointer"
                >
                  Delete
                </button>
              </div>,

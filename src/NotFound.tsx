...
const NotFound = () => {
  ...
  return (
    <Layout>
      <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-[150px] sm:text-[300px] md:text-[400px] font-black pointer-events-none text-blue-50/60">
        404
      </h1>
